...
| `03-identity-persistence-and-migrations.md` | In Progress | Introduces ChannelForge identifiers, persistence scaffolding, repositories, transactions, and migration metadata |
